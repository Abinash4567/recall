...
function HeroLeft() {
    return (
        <div className="w-1/2 flex items-center">
            <div>
                <div className="mb-4 flex text-4xl font-bold leading-none tracking-tight md:text-5xl lg:text-5xl">Remember<Heart color="#ff0000" strokeWidth={2.25} absoluteStrokeWidth />ones</div>
